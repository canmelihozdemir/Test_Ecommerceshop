...
namespace shopapp.data.Concrete.EfCore
{
    public static class SeedDatabase
    {
        ...
        {
            new Product(){Name="Samsun S5",Url="samsung-s5",Description="İyi telefon1",Price=2000,ImageUrl="1.jpg",IsApproved=true},
            ...
            new Product(){Name="Samsun S8",Url="samsung-s8",Description="İyi telefon4",Price=5500,ImageUrl="4.jpg",IsApproved=true},
            new Product(){Name="Samsun S9",Url="samsung-s9",Description="İyi telefon5",Price=6750,ImageUrl="5.jpg",IsApproved=true},
            new Product(){Name="Asus Laptop",Url="asus-laptop",Description="İyi laptop1",Price=11150,ImageUrl="5.jpg",IsApproved=true},
            new Product(){Name="Asus Bilgisayar",Url="asus-bilgisayar",Description="İyi Bilgisayar",Price=9150,ImageUrl="4.jpg",IsApproved=true},
        };
